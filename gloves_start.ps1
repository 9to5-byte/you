# Gloves - Start Local Server
# Run this script to view the Gloves website locally

$port = 3003
$path = Join-Path $PSScriptRoot "gloves"

Write-Host "Starting Gloves website..." -ForegroundColor Cyan

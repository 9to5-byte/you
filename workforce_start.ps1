# Workforce - Start Local Server
# Run this script to view the Workforce website locally

$port = 3000
$path = Join-Path $PSScriptRoot "workforce"

Write-Host "Starting Workforce website..." -ForegroundColor Cyan
